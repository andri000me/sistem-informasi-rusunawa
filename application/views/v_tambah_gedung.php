            ...
            <div class="page-content fade-in-up">
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                        <form class="form-horizontal" action="<?= base_url('aksi-tambah-gedung') ?>" method="post">
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Kode Gedung</label>
                                <div class="col-sm-9">
                                    <input class="form-control" type="text" name="gedung" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Nama Gedung</label>
                                <div class="col-sm-9">
                                    <input class="form-control" type="text" name="nama_gedung" required>
                                </div>
                            </div>
                            <div class="form-group row">
